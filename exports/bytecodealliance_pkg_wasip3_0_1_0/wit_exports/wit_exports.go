...
import (
	"go.bytecodealliance.org/pkg/exports/bytecodealliance_pkg_wasip3_0_1_0/export_wasi_http_0_3_0_handler"
...
func wasm_export_wasi_http_0_3_0_handler_handle(arg0 int32) int32 {
	return int32(witAsync.Run(func() {
		...
		case witTypes.ResultErr:
			...
			var variant69 int32
			switch payload.Tag() {
			case wasi_http_0_3_0_types.ErrorCode_DnsTimeout:
			...
			case wasi_http_0_3_0_types.ErrorCode_DnsError:
			...
			case wasi_http_0_3_0_types.ErrorCode_DestinationNotFound:
			...
			case wasi_http_0_3_0_types.ErrorCode_DestinationUnavailable:
			...
			case wasi_http_0_3_0_types.ErrorCode_DestinationIpProhibited:
			...
			case wasi_http_0_3_0_types.ErrorCode_DestinationIpUnroutable:
			...
			case wasi_http_0_3_0_types.ErrorCode_ConnectionRefused:
			...
			case wasi_http_0_3_0_types.ErrorCode_ConnectionTerminated:
			...
			case wasi_http_0_3_0_types.ErrorCode_ConnectionTimeout:
			...
			case wasi_http_0_3_0_types.ErrorCode_ConnectionReadTimeout:
			...
			case wasi_http_0_3_0_types.ErrorCode_ConnectionWriteTimeout:
			...
			case wasi_http_0_3_0_types.ErrorCode_ConnectionLimitReached:
			...
			case wasi_http_0_3_0_types.ErrorCode_TlsProtocolError:
			...
			case wasi_http_0_3_0_types.ErrorCode_TlsCertificateError:
			...
			case wasi_http_0_3_0_types.ErrorCode_TlsAlertReceived:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestDenied:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestLengthRequired:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestBodySize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestMethodInvalid:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestUriInvalid:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestUriTooLong:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestHeaderSectionSize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestHeaderSize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestTrailerSectionSize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpRequestTrailerSize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseIncomplete:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseHeaderSectionSize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseHeaderSize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseBodySize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseTrailerSectionSize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseTrailerSize:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseTransferCoding:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseContentCoding:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpResponseTimeout:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpUpgradeFailed:
			...
			case wasi_http_0_3_0_types.ErrorCode_HttpProtocolError:
			...
			case wasi_http_0_3_0_types.ErrorCode_LoopDetected:
			...
			case wasi_http_0_3_0_types.ErrorCode_ConfigurationError:
			...
			case wasi_http_0_3_0_types.ErrorCode_InternalError:
