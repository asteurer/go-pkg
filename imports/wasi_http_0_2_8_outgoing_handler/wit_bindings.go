...
func Handle(request *wasi_http_0_2_8_types.OutgoingRequest, options witTypes.Option[*wasi_http_0_2_8_types.RequestOptions]) witTypes.Result[*wasi_http_0_2_8_types.FutureIncomingResponse, wasi_http_0_2_8_types.ErrorCode] {
	...
	case 1:
		...
		case 1:
			...
			variant = wasi_http_0_2_8_types.MakeErrorCodeDnsError(wasi_http_0_2_8_types.DnsErrorPayload{Rcode: option1, InfoCode: option2})
		...
		case 14:
			...
			variant = wasi_http_0_2_8_types.MakeErrorCodeTlsAlertReceived(wasi_http_0_2_8_types.TlsAlertReceivedPayload{AlertId: option3, AlertMessage: option5})
		...
		case 22:
			...
			case 1:
				...
				option11 = witTypes.Some[wasi_http_0_2_8_types.FieldSizePayload](wasi_http_0_2_8_types.FieldSizePayload{FieldName: option9, FieldSize: option10})
			default:
				panic("unreachable")
			}
		...
		case 24:
			...
			variant = wasi_http_0_2_8_types.MakeErrorCodeHttpRequestTrailerSize(wasi_http_0_2_8_types.FieldSizePayload{FieldName: option14, FieldSize: option15})
		...
		case 27:
			...
			variant = wasi_http_0_2_8_types.MakeErrorCodeHttpResponseHeaderSize(wasi_http_0_2_8_types.FieldSizePayload{FieldName: option18, FieldSize: option19})
		...
		case 30:
			...
			variant = wasi_http_0_2_8_types.MakeErrorCodeHttpResponseTrailerSize(wasi_http_0_2_8_types.FieldSizePayload{FieldName: option23, FieldSize: option24})
