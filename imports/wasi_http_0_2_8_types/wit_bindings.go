...
func OutgoingBodyFinish(this *OutgoingBody, trailers witTypes.Option[*Fields]) witTypes.Result[witTypes.Unit, ErrorCode] {
	...
	case 1:
		...
		case 1:
			...
			variant = MakeErrorCodeDnsError(DnsErrorPayload{Rcode: option1, InfoCode: option2})
		...
		case 14:
			...
			variant = MakeErrorCodeTlsAlertReceived(TlsAlertReceivedPayload{AlertId: option3, AlertMessage: option5})
		...
		case 22:
			...
			case 1:
				...
				option11 = witTypes.Some[FieldSizePayload](FieldSizePayload{FieldName: option9, FieldSize: option10})
			default:
				panic("unreachable")
			}
		...
		case 24:
			...
			variant = MakeErrorCodeHttpRequestTrailerSize(FieldSizePayload{FieldName: option14, FieldSize: option15})
		...
		case 27:
			...
			variant = MakeErrorCodeHttpResponseHeaderSize(FieldSizePayload{FieldName: option18, FieldSize: option19})
		...
		case 30:
			...
			variant = MakeErrorCodeHttpResponseTrailerSize(FieldSizePayload{FieldName: option23, FieldSize: option24})
