...
const (
	...
	// `stream-error::closed`.
	StreamError_LastOperationFailed uint8 = 0
	// The stream is closed: no more input will be accepted by the
	// stream. A closed output-stream will return this error on all
	// future operations.
	StreamError_Closed uint8 = 1
)
...
func (self StreamError) LastOperationFailed() *wasi_io_0_2_8_error.Error {
	if self.tag != StreamError_LastOperationFailed {
		panic("tag mismatch")
	}
...
func MakeStreamErrorLastOperationFailed(value *wasi_io_0_2_8_error.Error) StreamError {
	return StreamError{StreamError_LastOperationFailed, value}
}
func MakeStreamErrorClosed() StreamError {
	return StreamError{StreamError_Closed, nil}
}
