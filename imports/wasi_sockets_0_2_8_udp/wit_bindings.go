...
func (self *UdpSocket) StartBind(network *wasi_sockets_0_2_8_network.Network, localAddress wasi_sockets_0_2_8_network.IpSocketAddress) witTypes.Result[witTypes.Unit, wasi_sockets_0_2_8_network.ErrorCode] {
	...
	case wasi_sockets_0_2_8_network.IpSocketAddress_Ipv4:
	...
	case wasi_sockets_0_2_8_network.IpSocketAddress_Ipv6:
...
func (self *UdpSocket) Stream(remoteAddress witTypes.Option[wasi_sockets_0_2_8_network.IpSocketAddress]) witTypes.Result[witTypes.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_0_2_8_network.ErrorCode] {
	...
	case 0:
		...
		result = witTypes.Ok[witTypes.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_0_2_8_network.ErrorCode](witTypes.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream]{F0: IncomingDatagramStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))), F1: OutgoingDatagramStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))))})
	case 1:
...
func (self *UdpSocket) LocalAddress() witTypes.Result[wasi_sockets_0_2_8_network.IpSocketAddress, wasi_sockets_0_2_8_network.ErrorCode] {
	...
	case 0:
		...
		case 0:
			...
			variant = wasi_sockets_0_2_8_network.MakeIpSocketAddressIpv4(wasi_sockets_0_2_8_network.Ipv4SocketAddress{Port: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))), Address: witTypes.Tuple4[uint8, uint8, uint8, uint8]{F0: uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 10)))), F1: uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 11)))), F2: uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 12)))), F3: uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 13))))}})

		case 1:

			variant = wasi_sockets_0_2_8_network.MakeIpSocketAddressIpv6(wasi_sockets_0_2_8_network.Ipv6SocketAddress{Port: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))), FlowInfo: uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 12))), Address: witTypes.Tuple8[uint16, uint16, uint16, uint16, uint16, uint16, uint16, uint16]{F0: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 16)))), F1: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 18)))), F2: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 20)))), F3: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 22)))), F4: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 24)))), F5: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 26)))), F6: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 28)))), F7: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 30))))}, ScopeId: uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 32)))})
	...
	case 0:
		...
		for index := 0; index < int(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), (2 * 4)))); index++ {
			...
			case 0:
				...
				variant = wasi_sockets_0_2_8_network.MakeIpSocketAddressIpv4(wasi_sockets_0_2_8_network.Ipv4SocketAddress{Port: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (4 + 2*4))))), Address: witTypes.Tuple4[uint8, uint8, uint8, uint8]{F0: uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (6 + 2*4))))), F1: uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (7 + 2*4))))), F2: uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (8 + 2*4))))), F3: uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (9 + 2*4)))))}})

			case 1:

				variant = wasi_sockets_0_2_8_network.MakeIpSocketAddressIpv6(wasi_sockets_0_2_8_network.Ipv6SocketAddress{Port: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (4 + 2*4))))), FlowInfo: uint32(*(*int32)(unsafe.Add(unsafe.Pointer(base), (8 + 2*4)))), Address: witTypes.Tuple8[uint16, uint16, uint16, uint16, uint16, uint16, uint16, uint16]{F0: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (12 + 2*4))))), F1: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (14 + 2*4))))), F2: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (16 + 2*4))))), F3: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (18 + 2*4))))), F4: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (20 + 2*4))))), F5: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (22 + 2*4))))), F6: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (24 + 2*4))))), F7: uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (26 + 2*4)))))}, ScopeId: uint32(*(*int32)(unsafe.Add(unsafe.Pointer(base), (28 + 2*4))))})

			default:
				panic("unreachable")
			}

			result = append(result, IncomingDatagram{Data: value, RemoteAddress: variant})
		}
